const ProviderNetease = (() => {
	...
	async function findLyrics(info) {
		...
		const searchResults = await Cartify.CosmosAsync.get(finalURL, null, requestHeader);
		...
		return await Cartify.CosmosAsync.get(lyricURL + items[itemId].id, null, requestHeader);
	}
