...
```bash
Cartify config custom_apps lyrics-plus
cartify.apply
```

### Credits

- A few parts of app code are taken from Spotify official app, including SyncedLyricsPage, CSS animation and TabBar. Please do not distribute these code else where out of Spotify/Cartify context.
