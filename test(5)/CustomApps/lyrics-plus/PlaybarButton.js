(function PlaybarButton() {
	...
	const button = new Cartify.Playbar.Button(
		"Lyrics Plus",
		...
		() =>
			Cartify.Platform.History.location.pathname !== "/lyrics-plus"
				? Cartify.Platform.History.push("/lyrics-plus")
				: Cartify.Platform.History.goBack(),
		false,
		Cartify.Platform.History.location.pathname === "/lyrics-plus",
		false
	);
	...
	if (Cartify.LocalStorage.get("lyrics-plus:visual:playbar-button") === "true") setPlaybarButton();
	...
	Cartify.Platform.History.listen((location) => {
