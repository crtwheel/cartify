...
function openConfig() {
	const configContainer = react.createElement(
		...
		react.createElement(OptionList, {
			items: [
				...
				{
					desc: Cartify.Locale.get("artist.albums"),
					key: "album",
				...
				{
					desc: Cartify.Locale.get("artist.singles"),
					key: "single-ep",
				...
				/* {
					desc: Cartify.Locale.get("artist.appears-on"),
					key: "appears-on",
				...
				{
					desc: Cartify.Locale.get("artist.compilations"),
					key: "compilations",
		...
		react.createElement(
			...
			react.createElement(
				...
				react.createElement(ButtonText, {
					text: Cartify.Locale.get("equalizer.reset"),
	...
	Cartify.PopupModal.display({
		title: Cartify.Locale.get("new_releases"),
