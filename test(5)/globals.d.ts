declare namespace Cartify {
	...
	namespace Player {
		...
		const origin: any;
		/**
		 * Register a listener `type` on Cartify.Player.
		 *
		 * On default, `Cartify.Player` always dispatch:
		...
		/**
		 * Dispatches an event at `Cartify.Player`.
		 *
		 * On default, `Cartify.Player` always dispatch
		 *  - `songchange` type when player changes track.
		 *  - `onplaypause` type when player plays or pauses.
	 ...
	 *
	 * Cartify.Keyboard is wrapper of this library to be compatible with legacy Spotify,
	...
	namespace ReactComponent {
		type ContextMenuProps = {
			 ...
			 */
			menu:
				| typeof Cartify.ReactComponent.Menu
				| typeof Cartify.ReactComponent.AlbumMenu
				| typeof Cartify.ReactComponent.PodcastShowMenu
				| typeof Cartify.ReactComponent.ArtistMenu
				| typeof Cartify.ReactComponent.PlaylistMenu;
			/**
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.ContextMenuProps
		 */
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.MenuProps
		 */
		const Menu: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.MenuItemProps
		 */
		const MenuItem: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.TooltipProps
		 */
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.IconComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.TextComponentProps
		 */
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.ConfirmDialogProps
		 */
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.SliderProps
		 */
		const Slider: any;
		/**
		 ...
		 *
		 * Props:
		 * @see Cartify.ReactComponent.ButtonProps
		 */
	...
	const Tippy: any;
	/**
	 * Cartify's predefined props for Tippy.js
	...
	/**
	 * Cartify's QraphQL wrapper for Spotify's GraphQL API endpoints
	 */
	namespace GraphQL {
		/**
		 ...
		 * @description A preinitialized version of `Cartify.GraphQL.Handler` using current context.
